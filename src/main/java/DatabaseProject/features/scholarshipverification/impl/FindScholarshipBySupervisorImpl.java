...
import DatabaseProject.features.scholarshipverification.usecases.FindScholarshipBySupervisor;
...
public class FindScholarshipBySupervisorImpl implements FindScholarshipBySupervisor{
    public void find() throws SQLException {
        Statement statement = DatabaseConfig.getConnection().createStatement();
        String sqlQuery = "select * from scholarship_request where status = " + "\"" + ScholarshipStatus.RequestedByStudent.toString() + "\"" + ";";
